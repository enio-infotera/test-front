...
export function HotelSortBar({ total, sortBy, onSortChange, onOpenFilters, hasActiveFilters }: HotelSortBarProps) {
  return (
    <div className="flex items-center justify-between gap-4 flex-wrap">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          <label className="text-sm text-slate-500 whitespace-nowrap hidden sm:block">Ordenar por:</label>
          <select
            value={sortBy}
